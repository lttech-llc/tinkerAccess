...
echo ""
echo "The ${dir}/server.cfg file needs edited for the server setup before restarting"
echo "The /etc/tinker-access-client.conf file needs edited for the client setup before restarting"
echo ""
